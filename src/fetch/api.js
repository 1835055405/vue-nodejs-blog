...
axios.defaults.headers.post["Content-Type"] =
  "application/x-www-form-urlencoded;charset=UTF-8;multipart/form-data;boundary=----WebKitFormBoundaryeOOd9EoQVo6B4Tgb";
...
export default {
  ...
  getUserInfo(id) {
    ...
    return fetchPost("/user/getUserInfo", params);
  },
  ...
  getMyInfo(id) {
    ...
    return fetchPost("/user/getInfo", params);
  },
  //后台登录接口
  ...
  userLogin(account, password) {
    ...
    return fetchPost("/user/userLogin", params);
  },
  userSignup(account, name, password) {
    ...
    return fetchPost("/user/userSignup", params);
  },
  // 前台更改个人信息的接口(更改信息这里比较特殊)
  changeUserInfo(formData) {
    console.log(formData);
    let data = formData;
    return fetchPost("/user/changeUserInfo", data);
  },
  ...
  getFriendship(id) {
    ...
    return fetchPost("/user/getFriendship", params);
  },
  getFriendRequest(id) {
    let params = {
      id
    };
    return fetchPost("/user/getFriendRequest", params);
  },
  addFriendRequest(receiverId, senderId) {
    ...
    return fetchPost("/user/addFriendRequest", params);
  },
  changeFriendRelationAccept(senderId, receiverId) {
    let params = {
      senderId,
      receiverId
    };
    return fetchPost("/user/changeFriendRelationAccept", params);
  },
  changeFriendRelationRefuse(senderId, receiverId) {
    let params = {
      senderId,
      receiverId
    };
    return fetchPost("/user/changeFriendRelationRefuse", params);
  },
  //所有文章的接口
  allArticleFront() {
    let params = {};
  ...
  makeComment(id, name, content, imgSrc, userId) {
    let params = {
      id,
      name,
      content,
