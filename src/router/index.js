...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "uploadArticle",
        component: resolve =>
          require(["../views/upload/uploadArticle"], resolve)
      },
      {
        //好友
        path: "/friend",
      ...
      },
      {
        ...
        name: "friendRequest",
        component: resolve =>
          require(["../views/friend/friendRequest"], resolve)
      },
      {
        //设置
        path: "/setting",
  ...
  },
  {
    path: "/userSignup",
    name: "userSignup",
    component: resolve => require(["../views/login/userSignup"], resolve)
  },
  {
    path: "/userLogOut",
    name: "userLogOut",
    component: resolve => require(["../views/login/userLogOut"], resolve)
  }
];
