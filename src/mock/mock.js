...
Mock.mock("/api/one", "post", {
  passage: {
    ...
    "content|1-5":
      '@cparagraph(30,50)<div style="text-align:center;margin:10px 0;"><img style="max-width:100%" src="@dataImage()" /></div>', //文章内容
    "tag|1-3": ["@ctitle(2,5)"],
    "comment|1-10": [
      {
        name: "@ctitle(2,4)",
        time: "201@integer(3,8)-@integer(1,12)-@integer(1,31)",
        img: "@dataImage",
